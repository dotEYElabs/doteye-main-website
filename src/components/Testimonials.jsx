    ...
    <div className="" id="Testimonials">
      ...
      >
        <SwiperSlide>
          ...
          <div className='flex flex-row w-full pb-[40px] px-[440px] xs:px-[7px] sm:px-[100px] md:px-[140px] lg:px-[300px] xl:px-[420px] 2xl:px-[520px]'>
            <div className='profile-box'>
              <div className="flex flex-col sm:flex-row justify-center items-center text-black m-2 shadow-black">
                  <div className="m-3">
                      ...
                      <p className="text-center text-black py-0 px-4">Vizag</p>
                  </div>
              </div>
            </div>
          </div>
          <div className='w-[30px] flex xl:flex lg:flex md:flex sm:flex xs:hidden items-center pr-[10px]'>
              <img src={shield} alt="" />
            </div>
          </div>
            ...
            <div className='profile-box'>
              <div className="flex flex-col sm:flex-row justify-center items-center text-black m-4 shadow-black">
                  <div className="m-3">
                      ...
                      <p className="text-center text-black py-0 px-4">Bangalore</p>
                  </div>
              </div>
            </div>
          </div>
          ...
          <div className='w-full px-[440px] xs:px-[7px] sm:px-[100px] md:px-[140px] lg:px-[300px] xl:px-[420px] 2xl:px-[560px]'>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center text-black m-4 shadow-black">
                <div className="m-3">
                    ...
                    <p className="text-center text-black py-0 px-4">Srikakulam</p>
            </div>
          </div>
        </div>
          </div>
          ...
          <div className='w-full px-[440px] xs:px-[7px] sm:px-[100px] md:px-[140px] lg:px-[300px] xl:px-[420px] 2xl:px-[520px]'>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center text-black m-4 shadow-black">
                <div className="m-3">
                    ...
                    <p className="text-center text-black px-4">Kalidindi</p>
            </div>
          </div>
        </div>
          </div>
